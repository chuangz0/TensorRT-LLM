    ...
    uint64_t freeSecondaryMemBytes, size_t extraCostMemory, bool const failFastOnAttentionWindowTooLarge)
{
    ...
    auto kvCacheManager = std::make_unique<KVCacheManager>(numKvHeadsPerLayer, sizePerHead, tokensPerBlock,
        ...
        kvCacheType == KvCacheType::kCROSS ? mModelConfig.getMaxEncoderLen() : mModelConfig.getMaxSequenceLen(),
        enableBlockReuse, kvCacheConfig.getOnboardBlocks(), kvCacheType, kvCacheConfig.getSecondaryOffloadMinPriority(),
